...
Enables Stripe checkout in your WooCommerce store. Accepts payments from Credit Cards, Debit Cards, Google Pay, Apple Pay, Alipay, SEPA, Klarna, WeChat Pay, Sofort, iDEAL, BECS, Bacs, Boleto, OXXO, Multibanco, Bancontact, P24, giropay, Afterpay/Clearpay and Affirm using Stripe.
...
Stripe checkout page is well optimized for conversion with less loading time, address auto-complete, real-time card validation, descriptive error messages, responsive checkout, [and more] (https://stripe.com/in/payments/checkout). 
...
Stripe is available in 47 countries. Below are the list of countries Stripe is currently available:
